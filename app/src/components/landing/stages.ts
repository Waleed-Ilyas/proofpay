...
export const STAGES: Stage[] = [
  ...
  },
  {
    ...
    holds: "Escrow account",
    moves: "The client, by releasing, or a ruling if disputed",
  },
  {
    ...
    tone: "flare",
    state: "Disputed",
    title: "The door splits. The money doesn't move.",
    body: "Either side raises a dispute, and both file what was agreed, what happened, and any screenshots that show it. The SOL is still in the escrow account, and only a ruling can move it.",
    holds: "Escrow account",
    moves: "Only a ruling, and only to the client or the expert",
  },
  {
